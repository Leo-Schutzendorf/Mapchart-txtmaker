...
def make_path_id(county_name, state_code):
    ...
    name = name.replace("'", " ")          # replace apostrophes with spaces
    name = name.replace("County", "Co")    # abbreviate "County" to "Co"
...
for state in states:
    ...
    for tr in table.find_all('tr'):
        ...
        countyName = countyName.replace("LaSalle", "La Salle").replace("DeWitt", "De Witt")# Illinois
        countyName = countyName.replace("LaRue", "La Rue")# Kentucky
        countyName = countyName.replace("Desoto", "De Soto")#Louisiana
        countyName = countyName.replace("Ste. Genevieve", "Sainte Genevieve")#Missouri
        countyName = countyName.replace("Ormsby", "Carson City")# Nevada
        countyName = countyName.replace("Coös", "Coos")# New Hampshire
        countyName = countyName.replace("LeFlore", "Le Flore")# Oklahoma
        countyName = countyName.replace("Shannon", "Oglala Lakota")# South Dakota
